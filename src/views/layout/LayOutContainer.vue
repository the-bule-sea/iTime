...
<template>
  <div class="common-layout">
    <a-layout>
      ...
      <a-layout-sider>
        <a-layout>
          <a-layout-header class="header">iTime 让每一秒都刚刚好</a-layout-header>
          <a-layout-content>
            <a-menu :selectedKeys="[currentRouteKey]">
              <router-link to="/timer">
                <a-menu-item key="/timer" :class="{ highlight: currentRouteKey === '/timer' }">
                  <template #icon>
                    <svg
                      t="1706536845495"
                      class="icon"
              ...
              <router-link to="/about">
                <a-menu-item key="/about" :class="{ highlight: currentRouteKey === '/about' }">
                  <template #icon>
                    <svg
                      t="1706536999715"
                      class="icon"
